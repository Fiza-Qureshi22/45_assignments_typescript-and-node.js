 let guests : string []=["Fiza","Ayesha","Habiba"];   // agr ame array mn ys kch nikalan ya dd karna ho to ha splice ko use karty hyn...
 ///// print the name that is nt invited fr dinnner

let unableAttend : string = guests.splice(0,1)[0];               // yaani 0 mn sy 1 element remove kardo or 2nd element ko 0 ki jagah dedo 
